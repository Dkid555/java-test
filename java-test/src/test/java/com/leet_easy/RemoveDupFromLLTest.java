...
//    RemoveDupFromLL remove = new RemoveDupFromLL();
    ...
    public void testRemoveDuplic1() {
        ...
        ListNode res = RemoveDupFromLL.removeDuplic(new ListNode(1, new ListNode(2, new ListNode(2, new ListNode(3)))));
...
//        assertEquals(new ListNode(1, new ListNode(2, new ListNode(3))), );
    ...
    public void testRemoveDuplic2() {
        ListNode res2 = RemoveDupFromLL.removeDuplic(new ListNode(1, new ListNode(2, new ListNode(2, new ListNode(3, new ListNode(5, new ListNode(5, new ListNode(5, new ListNode(5,
...
//        }
    ...
    public void testRemoveDuplic3() {
        ListNode res3 = RemoveDupFromLL.removeDuplic(new ListNode(10, new ListNode(10, new ListNode(11, new ListNode(13, new ListNode(14, new ListNode(51)))))));
        assertEquals("10,11,13,14,51", res3.toString().replaceAll(" ", ""));
    }

    public void testRemoveDuplic4() {
        ListNode res4 = RemoveDupFromLL.removeDuplic(new ListNode());
        assertEquals("0", res4.toString().replaceAll(" ", ""));
    }

    public void testRemoveDuplic5() {
        ListNode res5 = RemoveDupFromLL.removeDuplic(new ListNode(10));
        assertEquals("10", res5.toString().replaceAll(" ", ""));
    }

    public void testRemoveDuplic6() {
        ListNode res6 = RemoveDupFromLL.removeDuplic(new ListNode(1, new ListNode(1, new ListNode(2,

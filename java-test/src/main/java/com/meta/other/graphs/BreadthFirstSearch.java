...
import static com.meta.other.graphs.allAvailablePaths.findAllPaths;
import static com.meta.other.graphs.pathExistance.checkPathExistance;
...
//        dfs(graph, new HashSet<>(), 'A');
        ...
        System.out.println(checkPathExistance(graph, 'A', 'A', new HashSet<>(), new LinkedList<>()));

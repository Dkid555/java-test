...
public class VerifyPreorderSerializationofaBinaryTree {
    ...
    //
    // if we consider null as leaves, then all non-null node
    // provides 2 outdegree and 1 indegree (2 children and 1 parent), except root
    ...
    // because it provides two out degrees. If a serialization is correct, diff should never

...
// length n where the number of tickets that the ith person would like to buy is tickets[i].
//
// Each person takes exactly 1 second to buy a ticket. A person
// can only buy 1 ticket at a time and has to go back
// to the end of the line (which happens instantaneously)
// in order to buy more tickets. If a person does not have
